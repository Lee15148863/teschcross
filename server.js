...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", `https://${DOMAIN}`, `https://www.${DOMAIN}`, "http://localhost:*", "https://teschcross-git-1045728849939.europe-west1.run.app", "https://storeflow-test-mainpos-1045728849939.europe-west1.run.app", "https://www.google-analytics.com", "https://region1.google-analytics.com", "https://*.google-analytics.com", "https://www.googletagmanager.com", "https://www.facebook.com", "https://facebook.com", "https://images.unsplash.com"],
      fontSrc: ["'self'"],
      objectSrc: ["'none'"],
      mediaSrc: ["'self'"],
